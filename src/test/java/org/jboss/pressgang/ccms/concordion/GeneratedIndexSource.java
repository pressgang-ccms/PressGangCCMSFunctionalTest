...
/**
 * Based on https://github.com/zanata/zanata/blob/master/functional-test/src/test/java/org/zanata/concordion/GeneratedIndexSource.java
 * by Patrick Huang.
 */
@Slf4j
public class GeneratedIndexSource extends ClassPathSource {
